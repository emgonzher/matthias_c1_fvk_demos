...
main_dir=Run_ea0001_nseg4_Eta_141e5_pinc1_polyline_restartest #pcos1
        ...
        for inner_boundary in `echo $inner_boundary_list`; do
            ...
            for t_shape in `echo $t_shape_list`; do
                ...
                for rotate in `echo $rotate_list`; do
                    ...
                    args="--/restart9.dat --nplot 5 "$boundary_command_line_arg" "$t_shape_command_line_arg" "$rotate_command_line_arg" "$prev_sol_arg
