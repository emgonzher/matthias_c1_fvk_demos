...
// }
 ...
 // 1.2- Increment P_cos
    ...
    while ( abs(Parameters::P_mag - 1.0)>1e-5 ) // for (unsigned i = 0; i < 35; i++ )
  {
  // Bump
  Parameters::P_cos += 0.1;
  ...
  oomph_info << "P_cos = "  <<  Parameters::P_mag << " "
             << std::endl;
  }
  ...
  // 2-Loop to increment P_mag
   while ( abs(Parameters::P_mag - 10.0)>1e-5 ) // for (unsigned i = 0; i < 35; i++ )
  {
  // Bump
  Parameters::P_mag += 0.1;
