...
namespace Parameters
{
 ...
 /// Element area
 double Element_area = 0.01; // original 0.5 - tried with 0.2
...
public:
  ...
  /// Constructor
  UnstructuredC1PlateProblem(double const& element_area = 0.09); // miraqui - element_area
 ...
 : Element_area(element_area)
{
 ...
 unsigned nsegment = 10;//(unsigned)(MathematicalConstants::Pi/sqrt(Element_area)); //miraqui - element_area
...
return 0;
 ...
 // -------------------------------------------------------------------------------
 //unsigned i = 0;
//  while (Parameters::P_mag < 0.1) // for (unsigned i = 0; i < 35; i++ )
// {
//   // Bump
//   gamma_mod += gamma_inc;
//   Parameters::P_mag += 0.1;
//   //oomph_info << "blabla ... P = " << Parameters::P_mag << std::endl;
...
// }
 ...
 // =====================================================
 // 1.2- Increment P_cos // not necessary

  //   while ( Parameters::P_cos < 1.0 ) // for (unsigned i = 0; i < 35; i++ )
  // {
  // // Bump
...
// ======================================================
  ...
  // 2-Loop to increment P_mag
   while ( Parameters::P_mag < 5.0 ) //fabs(Parameters::P_mag - 5.0)>1e-5 ) // for (unsigned i = 0; i < 35; i++ )
  {
  // Bump
  ...
  // 4-Decreasing pressure until axixsymmetric
   while (Parameters::P_mag > 0 ) // for (unsigned i = 0; i < 35; i++ )
  {
  // Bump
  Parameters::P_mag -= 1;
