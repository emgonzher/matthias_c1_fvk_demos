...
// ===========
  ...
  //     double epsilon = 0.01;
  //     double theta = atan(x[2]/x[1]); // miraqui - define for different cuadrants
  //     unsigned N_mode = 6;
  //     pressure = P_mag + epsilon*cos(N_mode*theta);
  //   }
  // }
  ...
  for ( unsigned i = 0; i < n_step_gamma; i++ )
{
 ...
 // Change P_mag
 //unsigned i = 0;
 while (Parameters::P_mag < 33) // for (unsigned i = 0; i < 35; i++ )
{
  // Bump
  gamma_mod += gamma_inc;
